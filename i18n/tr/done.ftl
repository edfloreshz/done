...
# Warning
alpha-warning = Erken aşama geliştirme sürümünü çalıştırıyorsunuz. Çalışmaların devam ettiğini ve henüz tamamlanmaktan uzak olduğunu unutmayın.
...
# Welcome
select-list = Yan panelden liste seç
...
# Sidebar
all = Tümü
all-desc = Tüm görevler
today = Bugün
today-desc = Bugün yapılacaklar
starred = Yıldızlı
starred-desc = Yıldızlı görevler
