use super::theme_colors::Colors;
use iced::widget::{
	button, container, pane_grid, rule, scrollable, text, text_input,
};
...
#[derive(Debug, Clone)]
pub enum Theme {
	Selected(theme_colors::ThemeColors),
	Preview {
		selected: theme_colors::ThemeColors,
		preview: theme_colors::ThemeColors,
	},
}

impl Theme {
	pub fn preview(&self, theme: theme_colors::ThemeColors) -> Self {
		match self {
...
impl From<theme_colors::ThemeColors> for Theme {
	fn from(theme: theme_colors::ThemeColors) -> Self {
...
impl Default for Theme {
	fn default() -> Self {
		Self::from(theme_colors::ThemeColors::default())
	}
}
...
impl button::StyleSheet for Theme {
	...
	fn active(&self, style: &Self::Style) -> button::Appearance {
		match style {
			...
			Button::Destructive => button::Appearance {
				background: Some(Background::Color(self.colors().error.high_alpha)),
				text_color: self.colors().text.base,
				border_radius: 3.0.into(),
				..Default::default()
			},
	...
	fn pressed(&self, style: &Self::Style) -> button::Appearance {
		...
		match style {
			...
			Button::Destructive => button::Appearance { ..active },
	...
	fn hovered(&self, style: &Self::Style) -> button::Appearance {
		...
		match style {
			...
			Button::Secondary => button::Appearance {
				background: Some(Background::Color(self.colors().info.med_alpha)),
				text_color: self.colors().text.base,
				border_radius: 3.0.into(),
				..Default::default()
			},
			Button::Destructive => button::Appearance {
				background: Some(Background::Color(self.colors().error.med_alpha)),
				text_color: self.colors().text.base,
				border_radius: 3.0.into(),
				..Default::default()
			},
			...
			Button::Pane { .. } => button::Appearance {
				background: Some(Background::Color(
					if self.colors().background.is_dark() {
		...
		match style {
			Menu::Default => overlay::menu::Appearance {
				...
				selected_background: Background::Color(
					self.colors().background.high_alpha,
				),
			},
