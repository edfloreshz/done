use relm4::{
    ...
    SimpleComponent, adw, Component
};

use gtk::prelude::*;

use crate::{config::PROFILE, widgets::{component::{sidebar::{SidebarModel, SidebarOutput, SidebarInput}, content::{ContentModel, ContentOutput, ContentInput}}, factory::list::ListType, popover::{new_list::{NewListModel, NewListOutput}, theme_selector::MainMenuInput}}};
use crate::main_app;
...
impl SimpleComponent for App {
    ...
    fn init(
        ...
        let new_list_controller = NewListModel::builder()
            .launch(())
            .forward(&sender.input, |message| match message {
                NewListOutput::AddNewList(provider, name) => AppMsg::AddList(provider, name),
            });
        ...
        let model = App::new(sidebar_controller, content_controller, new_list_controller, about_dialog);
